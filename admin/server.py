...
SLOTS = [
    ('logo', 'Логотип АУРА (хедер, тёмный на белом)'),
    ('hero-bg', 'Хиро — фон (десктоп)'),
    ('hero-bg-mobile', 'Хиро — фон (мобильная картинка)'),
    ...
    ('location-map', 'Локация — карта района (десктоп)'),
    ('location-map-mobile', 'Локация — карта района (мобильная картинка)'),
    ('infrastructure-banner-bg', 'Внутренняя инфраструктура — баннер (фото на всю ширину)'),
    ('infrastructure-banner-bg-mobile', 'Внутренняя инфраструктура — баннер (мобильное фото, высота по фото)'),
    ...
    ('amenities-banner-bg-mobile', 'Пространства для отдыха — баннер (мобильное фото, высота по фото)'),
    ...
    ('aesthetics-banner-bg-mobile', 'Эстетика и функциональность — баннер (мобильное фото, высота по фото)'),
    ...
    ('parking-bg', 'Паркинг — фото справа'),
    ('cellars-bg', 'Келлеры — фото справа'),
    ('comfort-photo-1', 'Повседневный комфорт — 1: консьерж-сервис'),
    ('comfort-photo-2', 'Повседневный комфорт — 2: беллмен-сервис'),
    ('comfort-photo-3', 'Повседневный комфорт — 3: мобильное приложение'),
    ('promo-photo-1', 'Акции — 1: рассрочка 0%'),
    ('promo-photo-2', 'Акции — 2: три акционные квартиры'),
    ('promo-photo-3', 'Акции — 3: семейная программа'),
    ('terms-photo', 'Условия покупки — одно фото на все 3 таба'),
    ('footer-logo-aura', 'Футер — логотип АУРА'),

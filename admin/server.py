...
SLOTS = [
    ...
    ('layout-1k', 'Планировки — пример 1-комнатной'),
    ('layout-2k', 'Планировки — пример 2-комнатной'),
    ('layout-3k', 'Планировки — пример 3-комнатной'),
    ('layout-4k', 'Планировки — пример 4-комнатной+'),
]
